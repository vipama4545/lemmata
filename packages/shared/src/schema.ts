...
//
//   content — the lexicon, the paradigms, the stories. Generated by the scripts under
//     scripts/, loaded by `npm run db:seed`, and never written by the app. Every row is
//     replaceable from data/*.json, so nothing here needs a backup.
//
...
// two additions below, which are ours:
//
